...
// include: C:\Users\keju\AppData\Local\Temp\tmpskeyjz89.js
...
Module['FS_createPath']("/assets", "textures", true, true);
    ...
    loadPackage({"files": [{"filename": "/assets/textures/Picture1.jpg", "start": 0, "end": 5319}], "remote_package_size": 5319});

  })();

// end include: C:\Users\keju\AppData\Local\Temp\tmpskeyjz89.js
// include: C:\Users\keju\AppData\Local\Temp\tmp0gcvab1t.js

    // All the pre-js content up to here must remain later on, we need to run
    // it.
    if (Module['$ww'] || (typeof ENVIRONMENT_IS_PTHREAD != 'undefined' && ENVIRONMENT_IS_PTHREAD)) Module['preRun'] = [];
    var necessaryPreJSTasks = Module['preRun'].slice();
  // end include: C:\Users\keju\AppData\Local\Temp\tmp0gcvab1t.js
// include: C:\Users\keju\AppData\Local\Temp\tmph3e6eb1v.js

    if (!Module['preRun']) throw 'Module.preRun should exist because file support used it; did a pre-js delete it?';
    necessaryPreJSTasks.forEach((task) => {
      if (Module['preRun'].indexOf(task) < 0) throw 'All preRun tasks that exist before user pre-js code should remain after; did you replace Module or modify Module.preRun?';
    });
  // end include: C:\Users\keju\AppData\Local\Temp\tmph3e6eb1v.js
...
var ASM_CONSTS = {
  92912: () => { if (document.fullscreenElement) return 1; },  
 92958: () => { return document.getElementById('canvas').width; },  
 93010: () => { return parseInt(document.getElementById('canvas').style.width); },  
 ...
 93276: () => { return screen.width; },  
 93301: () => { document.exitFullscreen(); },  
 93328: () => { setTimeout(function() { Module.requestFullscreen(false, true); setTimeout(function() { canvas.style.width="unset"; }, 100); }, 100); },  
 93461: () => { return window.innerWidth; },  
 93487: () => { return window.innerHeight; },  
 93514: () => { if (document.fullscreenElement) return 1; },  
 93560: () => { return document.getElementById('canvas').width; },  
 93612: () => { return parseInt(document.getElementById('canvas').style.width); },  
 93680: () => { if (document.fullscreenElement) return 1; },  
 93726: () => { return document.getElementById('canvas').width; },  
 93778: () => { return screen.width; },  
 93803: () => { return window.innerWidth; },  
 93829: () => { return window.innerHeight; },  
 93856: () => { if (document.fullscreenElement) return 1; },  
 93902: () => { return document.getElementById('canvas').width; },  
 93954: () => { return screen.width; },  
 93979: () => { document.exitFullscreen(); },  
 94006: () => { if (document.fullscreenElement) return 1; },  
 94052: () => { return document.getElementById('canvas').width; },  
 94104: () => { return parseInt(document.getElementById('canvas').style.width); },  
 94172: () => { document.exitFullscreen(); },  
 94199: ($0) => { document.getElementById('canvas').style.opacity = $0; },  
 94257: () => { return screen.width; },  
 94282: () => { return screen.height; },  
 94308: () => { return window.screenX; },  
 94335: () => { return window.screenY; },  
 94362: ($0) => { navigator.clipboard.writeText(UTF8ToString($0)); },  
 94415: ($0) => { document.getElementById("canvas").style.cursor = UTF8ToString($0); },  
 94486: () => { document.getElementById('canvas').style.cursor = 'none'; },  
 94543: ($0, $1, $2, $3) => { try { navigator.getGamepads()[$0].vibrationActuator.playEffect('dual-rumble', { startDelay: 0, duration: $3, weakMagnitude: $1, strongMagnitude: $2 }); } catch (e) { try { navigator.getGamepads()[$0].hapticActuators[0].pulse($2, $3); } catch (e) { } } },  
 94799: ($0) => { document.getElementById('canvas').style.cursor = UTF8ToString($0); },  
 94870: () => { if (document.fullscreenElement) return 1; },  
 94916: () => { return window.innerWidth; },  
 94942: () => { return window.innerHeight; },  
 94969: () => { if (document.pointerLockElement) return 1; }
};
var wasmImports = {
  /** @export */
